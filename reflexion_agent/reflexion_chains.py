...
).partial(                      # Partial is used to pre-populate and not during invocation time
...
# tool_choice forces the llm to use the tool specified
...
revisor_chain = first_responder_prompt_template.partial(
